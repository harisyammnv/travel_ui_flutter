...
import 'package:travelui/widgets/hotels_carousel.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildIcon(int index){
    return GestureDetector(
      onTap: (){
        ...
        height: 60.0,
        width: 60.0,
        decoration: BoxDecoration(color: _selectedIndex == index ? Theme.of(context).accentColor : Color(0xFFE7BEE), 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(child: 
      ListView(padding: EdgeInsets.symmetric(vertical:30.0),
        children: <Widget>[
        Padding(
